...
CUDA_VISIBLE_DEVICES=0 nohup python -W ignore metrics/measure_multiple.py \
  --original_dir outputs_cora_multi_small/celebrity/one/original \
  --neutral_dir outputs_cora_multi_small/celebrity/one/erase \
  --targets "Adam Driver" \
  ...
  > metrics/results/cora_multiple_celebrities_one.log 2>&1 &

CUDA_VISIBLE_DEVICES=1 nohup python -W ignore metrics/measure_multiple.py \
  --original_dir outputs_cora_multi_small/celebrity/two/original \
  --neutral_dir outputs_cora_multi_small/celebrity/two/erase \
  ...
  > metrics/results/cora_multiple_celebrities_two.log 2>&1 &

CUDA_VISIBLE_DEVICES=2 nohup python -W ignore metrics/measure_multiple.py \
  --original_dir outputs_cora_multi_small/celebrity/five/original \
  --neutral_dir outputs_cora_multi_small/celebrity/five/erase \
  ...
  > metrics/results/cora_multiple_celebrities_five.log 2>&1 &